...
include 'conexion.php';
    ...
    $sql="select titulo, descripcion, total, id_producto, url from producto where tipo=0";
...
$z1='';
               ...
               $z1.=' <div class="col-lg-4">
                            <div class="panel panel-primary">
                               ...
                               <div class="panel-body">
                                    ...
                                    <img src="'.$row[4].'" alt="..." class="img-thumbnail">
                                    </ul>
                                    </div>
                                </div>
 ...
 <form action="ad_pedidos_bd_delete.php?clave_usuario='.$id.'&clave_pedido='.$row[3].'" method="post">
                                       <input type="text" value="'.$row[3].'" name="clave_pedido"          class="form-control inputcentrado" disabled="disabled">
                                           <input type="submit" name="boton" class="btn btn-block btn-danger btn-lg"        value="ELIMINAR">
                                       </form>
                            </div>
...
print '<div class="alert alert-info">
    ...
    $sql="select titulo, descripcion, total, id_producto, url from producto where tipo=1";
